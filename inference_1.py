...
# Reuse functions from process_audio_1
...
def split_audio(audio_path, output_folder, base_name, split_duration=60000, overlap_duration=30000):
    ...
    split_duration and overlap_duration are in milliseconds
    """
    try:
        ...
        for i, start in enumerate(start_points):
            ...
            if len(segment) < overlap_duration:  # Skip if segment is too short
                continue
...
def process_inference_step2(input_folder, output_folder):
    ...
    with open(metadata_path, newline='') as csvfile:
        ...
        for row in tqdm(list(reader), desc="Splitting Files"):
            ...
            # Add entries for each split to metadata
